...
def predict():
    ...
    if output != 0.0:
        return render_template("home.html",prediction_text="The Customer is not satisfied with the airline service")
    return render_template("home.html",prediction_text="The Customer is satisfied with the airline service")
